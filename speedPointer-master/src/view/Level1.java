...
public class Level1 {
    ...
    public Level1() {
        ...
        //gameLabel=new Label("");
        gameLabel=new Label("Level1");
        gameLabel.setLayoutX(200);
        gameLabel.setLayoutY(200);
    ...
    public void gameOver(){   //we should avoid  this method.. advised by Shawan

//      gameoverGroup.setVisible(true); //mod by anim
//      game.setVisible(false);
        ...
        dataBaseService.updatescore(login.getLogeduser(),score);*/////mod by anim
        //login.getLogeduser();
